...
| P1-DOCS-01 | Agent and Human users can follow the complete authority-aware Phase 1 journey with shell-portable commands from exact packed Skills | Public guide, canonical Skill route, installed Codex/Claude Product Intent bridges, packed POSIX/PowerShell command execution, and generated-copy validation | #138 | Complete |

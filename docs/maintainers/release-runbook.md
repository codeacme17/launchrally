...
```bash
git tag --annotate v0.4.2 <approved-main-sha> --message "LaunchRally 0.4.2 Phase 1 Experimental"
...
result, exact CLI result, and both Plugin results to issue #201. Keep Phase 1

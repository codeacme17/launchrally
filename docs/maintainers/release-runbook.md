...
```bash
git tag --annotate v0.4.3 <approved-main-sha> --message "LaunchRally 0.4.3 Phase 1 Experimental"
...
result, exact CLI result, and both Plugin results to issue #210. Keep Phase 1

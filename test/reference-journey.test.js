...
const directJourney = {
  ...
  compatibility: {
    launcher: {
      supported_versions: ["0.3.0", "0.3.2", "0.4.0", currentVersion],
    },
    engine: {
      supported_versions: ["0.2.2", "0.3.0", "0.3.2", "0.4.0", currentVersion],
    },
  },
  cli: {
...
test("the canonical Skill declares Launcher compatibility and typed authority lifecycle routing", async () => {
  ...
  assert.deepEqual(journey.compatibility, {
    ...
    launcher: {
      package: "@launchrally/cli",
      supported_versions: ["0.3.0", "0.3.1", "0.3.2", "0.4.0", cliPackage.version],
    },
    execution_authority: {
    ...
    engine: {
      package: "@launchrally/cli",
      supported_versions: ["0.2.2", "0.3.0", "0.3.1", "0.3.2", "0.4.0", cliPackage.version],
  ...
  assert.deepEqual(
    ...
    ["0.3.0", "0.3.1", "0.3.2", "0.4.0", journey.compatibility.plugin.version],
